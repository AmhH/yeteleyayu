package com.me.demo.restassured;
...
public class RestAssuredIntegrationTest {
    ...
    public static void before() throws Exception{
        ...
        stubFor(get(urlEqualTo(JSON_PATH)).willReturn(
                aResponse().withStatus(200)
                        .withHeader("Content-Type", APPLICATION_JSON)
                        .withBody("[1,2,3]")));
    }
    ...
    @Test
    public void ananymousJsonRootValidation(){
        when().get(JSON_PATH).then().body("$", hasItems(1,2,3));
    }
